...
export class VehiculoCategoriaController {
  ...
  async find(
    ...
    return this.vehiculoRepository.tiene_categoria(id).find(filter);
  }
  ...
  async create(
    ...
    return this.vehiculoRepository.tiene_categoria(id).create(categoria);
  }
  ...
  async patch(
    ...
    return this.vehiculoRepository.tiene_categoria(id).patch(categoria, where);
  }
  ...
  async delete(
    ...
    return this.vehiculoRepository.tiene_categoria(id).delete(where);
  }
}
